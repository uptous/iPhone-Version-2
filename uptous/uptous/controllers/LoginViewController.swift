...
class LoginViewController: GeneralViewController {
    ...
    override func viewDidLoad() {
       ...
       // emailTxtField.text! = "eceadmin@pjcc.org"
       // passwordTxtField.text! = "supportpjcc"  //testp17@uptous.com
        
        //emailTxtField.text! = "testp2@uptous.com"
        //passwordTxtField.text! = "alpha1" //support@uptous.com with password: gotouptous1
        //emailTxtField.text! = "eceadmin@pjcc.org"
        //passwordTxtField.text! = "supportpjcc"
