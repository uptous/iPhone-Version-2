...
class MyUpToUsCalendarViewController: GeneralViewController{
    ...
    fileprivate struct landingCellConstants {
        ...
        static var rowHeight:CGFloat! = 105
    }
    ...
    func getEventList() {
        ...
        DataConnectionManager.requestGETURL(api: EventAPI, para: ["":""], success: {
            ...
            if self.eventList.count > 0 {
                print(UserPreferences.SelectedCommunityName)
        ...
        func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
            if tableView == communityTableView {
                ...
                if(selectedIndexPath == indexPath.row && selectedIndexPath != -1) {
                    ...
                    return 200 //+ calculateHeight(data.eventDescription!, width: detailLabelWidt)+detailLabelOriginY + 20
                }else {
                    return 105.0
                }
            }
