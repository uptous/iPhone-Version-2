...
class SignUpDriverViewController: GeneralViewController {
    ...
    func updateData(_ data: SignupSheet) {
        ...
        /*detailHeightContraint.constant = 38
        organizerViewYContraint.constant = 45
        eventViewYContraint.constant = 141
        detailViewHeightContraint.constant = 137*/
        ...
        if data.contact2 == "" || data.contact2 == "" {
            ...
            //eventViewYContraint.constant = detailHeightContraint.constant + 2.0
            //print(eventViewYContraint.constant)
            //detailViewHeightContraint.constant = detailHeightContraint.constant + 79.0
        }else {
            organizerView.isHidden = false
            organizerViewYContraint.constant = detailHeightContraint.constant + 2.0
            eventViewYContraint.constant = detailHeightContraint.constant + organizerViewYContraint.constant + 2.0
        }
        print(organizerViewYContraint.constant)
        print(detailHeightContraint.constant)
        detailViewHeightContraint.constant = detailHeightContraint.constant + organizerViewYContraint.constant + 79.0 + 10
        print(detailViewHeightContraint.constant)*/
